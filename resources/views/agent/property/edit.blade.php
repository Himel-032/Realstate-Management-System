                    ...
                    <form action="{{ route('agent_property_update', $property->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="bedroom" class="form-control" value="{{ $property->bedroom }}"
                                    min="0" max="100">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="" class="form-label">Bathrooms *</label>
                                <input type="number" name="bathroom" class="form-control" value="{{ $property->bathroom }}"
                                    min="0" max="100">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="" class="form-label">Size (Sqft) *</label>
                                <input type="number" name="size" class="form-control" value="{{ $property->size }}" min="0"
                                    max="50000">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="" class="form-label">Floor</label>
                                <input type="number" name="floor" class="form-control" value="{{ $property->floor }}" min="0"
                                    max="100">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="" class="form-label">Garage</label>
                                <input type="number" name="garage" class="form-control" value="{{ $property->garage }}" min="0"
                                    max="100">
                            </div>
                            <div class="col-md-4 mb-3">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="built_year" class="form-control" value="{{ $property->built_year }}"
                                    min="1990" max="{{ date('Y') }}">
                            </div>
                            <div class="col-md-4 mb-3">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="map" class="form-control h-150" cols="30"
                                    rows="10">{{ $property->map }}</textarea>
                            </div>
                            <div class="col-md-12 mb-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-check">
                                            <input name="amenity[]" class="form-check-input" type="checkbox" value="{{ $amenity->id }}" id="chk{{ $loop->iteration }}"
                                                {{ in_array($amenity->id, $existing_amenities) ? 'checked' : '' }}>
