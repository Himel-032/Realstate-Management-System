                    ...
                    <form action="{{ route('agent_property_store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="size" class="form-control" value="{{ old('size') }}" min="0" max="50000">
                            </div>
                            <div class="col-md-4 mb-3">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="built_year" class="form-control" value="{{ old('built_year') }}" min="1990" max="{{ date('Y') }}">
                            </div>
                            <div class="col-md-4 mb-3">
