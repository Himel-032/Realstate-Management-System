                        ...
                        <div class="card">
                            <div class="card-body">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered table-border-0">
                                                        <tbody>
                                                            <tr>
                                                                <td class="w-50">
                                                                    <img src="{{ asset('uploads/'. $global_setting->logo) }}" alt="" class="w_150">
                                                                </td>
                                                                <td class="w-50">
                                                            ...
                                                            <tr>
                                                                <td class="w-50">
                                                                    <div class="invoice-middle-left">
                                                                        ...
                                                                        <p class="mb_0">{{ $order->agent->city }},
                                                                            {{ $order->agent->state }} - {{ $order->agent->zip }},
                                                                            {{ $order->agent->country }}
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                                <td class="w-50">
                                                                    <div class="invoice-middle-right">
                                                                        ...
                                                                        <p class="mb_0">+8801608639395</p>
                                                                        <p class="mb_0">Dhamrai</p>
                                                                        <p class="mb_0">Dhaka-1345, Bangladesh</p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                ...
                                <div class="print-button mt_25">
                                    <a onclick="printInvoice()" href="javascript:;" class="btn btn-primary"><i class="fas fa-print"></i>
                                        Print</a>
                                </div>
                                <script>
